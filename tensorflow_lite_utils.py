...
def get_all_objects(interpreter):
    return dict(
        boxes=interpreter.get_tensor(interpreter.get_output_details()[0]['index']).squeeze(axis=0),
        labels=interpreter.get_tensor(interpreter.get_output_details()[1]['index']).astype(int).squeeze(axis=0),
        scores=interpreter.get_tensor(interpreter.get_output_details()[2]['index']).squeeze(axis=0),
        count=interpreter.get_tensor(interpreter.get_output_details()[3]['index'])
    )
